#' @title gbif data with 1 record
#' @description gbif data for testing the Darwinazier (via bddwc)
#' @format A data frame with 1 rows and 111 variables:
#' \describe{
...
#'   \item{\code{http://unknown.org/nick}}{character COLUMN_DESCRIPTION}
#'   \item{\code{taxonID}}{character COLUMN_DESCRIPTION}
#'   \item{\code{http://unknown.org/occurrenceDetails}}{character COLUMN_DESCRIPTION}
...
#' @title gbif data with 1,000 record
#' @description gbif data for testing data checks (via bdchecks)
#' @format A data frame with 1,000 rows and 111 variables:
#' \describe{
#'   \item{\code{name}}{character COLUMN_DESCRIPTION}
#'   \item{\code{longitude}}{double COLUMN_DESCRIPTION}
#'   \item{\code{latitude}}{double COLUMN_DESCRIPTION}
...
#' @title gbif data with 10,000 records
#' @description gbif data for testing data checks (via bdchecks)
#' @format A data frame with 10000 rows and 111 variables:
#' \describe{
#'   \item{\code{name}}{character COLUMN_DESCRIPTION}
#'   \item{\code{longitude}}{double COLUMN_DESCRIPTION}
#'   \item{\code{latitude}}{double COLUMN_DESCRIPTION}
...
#' @title gbif data with newly parsed 10,000 records (Timestamp: Tue Dec 17 18:55:27 2019)
#' @description gbif data for testing data checks (via bdchecks)
